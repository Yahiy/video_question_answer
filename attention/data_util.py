...
def pad_sequences(sequences, pad_token="[PAD]", pad_location="RIGHT", max_length=None):
    ...
    num_padding = max_length - len(sequences)
    if num_padding == 0:
        new_sentence = sequences
    elif num_padding < 0:
        new_sentence = sequences[:num_padding]
    elif pad_location == "RIGHT":
        new_sentence = sequences + [pad_token] * num_padding
    elif pad_location == "LEFT":
        new_sentence = [pad_token] * num_padding + sequences
    else:
